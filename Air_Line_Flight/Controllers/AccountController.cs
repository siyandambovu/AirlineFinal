...
namespace Air_Line_Flight.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var message = await EmailTemplate("WelcomeMail");
                    message = message.Replace("@ViewBag.Name", CultureInfo.CurrentCulture.TextInfo.ToTitleCase(model.Name));

                    await MessageService.SendEmailAsync(model.Email, "Welcome!", message);
        ...
        //public async Task<ActionResult> SendMail(RegisterViewModel model)
        //{
        //    var message = await EmailTemplate("WelcomeMail");
        //    message = message.Replace("@ViewBag.Name", CultureInfo.CurrentCulture.TextInfo.ToTitleCase(model.Name));
